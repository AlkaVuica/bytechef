...
import static com.bytechef.platform.user.domain.AuthorityAsserts.assertAuthorityAllPropertiesEquals;
import static com.bytechef.platform.user.domain.AuthorityAsserts.assertAuthorityAllUpdatablePropertiesEquals;
...
class AuthorityControllerIntTest {
    ...
    public static Authority createEntity() {
        ...
        Authority authority = new Authority().name(uuid.toString());
    ...
    void createAuthority() throws Exception {
        ...
        var returnedAuthority = om.readValue(
            restAuthorityMockMvc
                .perform(post(ENTITY_API_URL).with(csrf())
    ...
    void deleteAuthority() throws Exception {
        // Initialize the database
        authority.setName(UUID.randomUUID()
            .toString());
        authorityRepository.save(authority);
        ...
        restAuthorityMockMvc
            .perform(delete(ENTITY_API_URL_ID, authority.getName()).with(csrf())
