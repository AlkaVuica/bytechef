...
import com.bytechef.platform.user.web.rest.errors.EmailAlreadyUsedException;
import com.bytechef.platform.user.web.rest.errors.LoginAlreadyUsedException;
import com.bytechef.platform.web.rest.error.BadRequestAlertException;
...
public class UserController {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody AdminUserDTO userDTO) throws URISyntaxException {
        ...
        } else if (userService.fetchUserByLogin(login.toLowerCase())
            .isPresent()) {
            throw new LoginAlreadyUsedException();
        } else if (userService.fetchUserByEmail(userDTO.getEmail())
            .isPresent()) {
