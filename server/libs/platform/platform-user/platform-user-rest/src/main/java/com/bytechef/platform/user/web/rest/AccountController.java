...
import com.bytechef.platform.user.web.rest.errors.InvalidPasswordException;
...
public class AccountController {
    ...
    public AccountController(
        MailService mailService, PersistentTokenService persistentTokenService, UserService userService) {
