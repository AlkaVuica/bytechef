...
class UserServiceIntTest {
    ...
    void testRemoveOldPersistentTokens() {
        ...
        int existingCount = persistentTokenRepository.findAllByUserId(user.getId())
            .size();
        ...
        assertThat(persistentTokenRepository.findAllByUserId(user.getId())).hasSize(existingCount + 2);

        userService.removeOldPersistentTokens();

        assertThat(persistentTokenRepository.findAllByUserId(user.getId())).hasSize(existingCount + 1);
    }
    ...
    void assertThatUserMustExistToResetPassword() {
        ...
        assertThat(maybeUser.orElse(null)
