...
public class ConnectedUserAuthenticationFilter extends OncePerRequestFilter {
    ...
    private Authentication getAuthentication(HttpServletRequest request) {
        ...
        String externalReferenceCode = Jwts.parser()
        ...
        if (!connectedUserService.hasConnectedUser(externalReferenceCode, environment)) {
            connectedUserService.createConnectedUser(externalReferenceCode, environment);
        }

        return new ConnectedUserAuthenticationToken(externalReferenceCode, AuthorityUtils.NO_AUTHORITIES);
    }
