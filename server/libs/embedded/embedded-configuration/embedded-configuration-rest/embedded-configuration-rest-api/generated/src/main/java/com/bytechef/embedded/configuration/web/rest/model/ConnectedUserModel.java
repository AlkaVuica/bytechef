...
public class ConnectedUserModel {
  ...
  */
  ...
  /**
   * The external referenceCode.
   * @return externalId
  */
  
  @Schema(name = "externalId", accessMode = Schema.AccessMode.READ_ONLY, description = "The external referenceCode.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
