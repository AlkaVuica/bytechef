...
public class ConnectedUserServiceImpl implements ConnectedUserService {
    ...
    @Override
    public void createConnectedUser(@NonNull String externalReferenceCode, @NonNull Environment environment) {
        ConnectedUser connectedUser = new ConnectedUser();

        connectedUser.setEnabled(true);
        connectedUser.setEnvironment(environment);
        connectedUser.setExternalReferenceCode(externalReferenceCode);
    ...
    public boolean hasConnectedUser(@NonNull String externalReferenceCode, @NonNull Environment environment) {
        return connectedUserRepository
            .findByExternalReferenceCodeAndEnvironment(externalReferenceCode, environment.ordinal())
            .isPresent();
    }
