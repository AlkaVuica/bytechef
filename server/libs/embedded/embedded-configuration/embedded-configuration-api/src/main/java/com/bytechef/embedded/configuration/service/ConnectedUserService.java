...
public interface ConnectedUserService {
    ...
    void createConnectedUser(@NonNull String externalReferenceCode, @NonNull Environment environment);

    void deleteConnectedUser(long id);

    void enableConnectedUser(long id, boolean enable);

    boolean hasConnectedUser(@NonNull String externalReferenceCode, @NonNull Environment environment);
