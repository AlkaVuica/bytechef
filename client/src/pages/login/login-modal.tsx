...
const LoginModal = (props: ILoginModalProps) => {
    const login = ({password, rememberMe, username}) => {
    ...
    return (
        <Modal autoFocus={false} backdrop="static" id="login-page" isOpen={props.showModal} toggle={handleClose}>
            <Form onSubmit={handleLoginSubmit}>
                ...
                <ModalBody>
                    ...
                    <Alert color="warning">
                        <Link data-cy="forgetYourPasswordSelector" to="/account/reset/request">
