...
export function IntegrationInstanceConfigurationWorkflowModelToJSON(value?: Omit<IntegrationInstanceConfigurationWorkflowModel, 'createdBy'|'createdDate'|'id'|'lastModifiedBy'|'lastModifiedDate'> | null): any {
    if (value == null) {
        return value;
    }
    return {
