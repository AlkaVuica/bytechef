...
export interface UpdateIntegrationInstanceConfigurationWorkflowRequest {
    id: number;
    workflowId: number;
    integrationInstanceConfigurationWorkflowModel: Omit<IntegrationInstanceConfigurationWorkflowModel, 'createdBy'|'createdDate'|'id'|'lastModifiedBy'|'lastModifiedDate'>;
}
